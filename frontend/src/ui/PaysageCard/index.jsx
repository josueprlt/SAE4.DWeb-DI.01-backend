...
export default function PaysageCard() {
  ...
  return (
    <>
      <figure className="group/card w-60 h-36 cursor-pointer overflow-hidden rounded-xl bg-colorBgBtnCate transition-transform delay-500 hover:h-auto hover:scale-125">
